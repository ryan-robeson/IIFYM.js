var testData = [
  ...
  // Mifflin-St Jeor
  {
    ...
    expected: { 'bmr': 1779, 'tdee': 2568, 'protein': 119, 'fat': 59.5, 'carbs': 389.1 }
  },
  {
    ...
    expected: { 'bmr': 1372, 'tdee': 1981, 'protein': 90.3, 'fat': 45.2, 'carbs': 303.4 }
  },
  // Katch-McArdle
  {
    ...
    expected: { 'bmr': 1417, 'tdee': 2045, 'protein': 74.6, 'fat': 37.3, 'carbs': 352.7 }
  },
  {
    ...
    expected: { 'bmr': 1941, 'tdee': 2135, 'protein': 128, 'fat': 56, 'carbs': 279.8 }
  },
  // Metric
  // Mifflin-St Jeor
  {
    ...
    expected: { 'bmr': 1672, 'tdee': 2413, 'protein': 125.7, 'fat': 62.9, 'carbs': 336.1 }
  },
  // Katch-McArdle
  {
    ...
    expected: { 'bmr': 1075, 'tdee': 1437, 'protein': 50.3, 'fat': 25.1, 'carbs': 252.4 }
  },
];
